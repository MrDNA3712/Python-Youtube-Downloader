...
def getLinks(id):
    ...
    pr = json.loads(response['player_response'][0])
...
if __name__=='__main__':
    ...
    parser.add_argument("video_filename", help="Where the downloaded video will be saved",nargs='?', default='download.mp4')
    ...
    options = getLinks(args.video_id[0])
    ...
    if not args.video_filename[-4:] == '.mp4':
